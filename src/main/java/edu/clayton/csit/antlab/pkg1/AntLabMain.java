 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  //Replaced with name and lakerID
		  Person1 p1 = new Person1("Milton");
		  toPrint += p1.toString("900688796");
		  //Person2 replace P2 with your name
		  //and csuLaker with your laker id
		  Person2 p2 = new Person2("Bryce");
		  toPrint += p2.toString("900744134");
		  //Person3 replace P3 with your name
		  //and csuLaker3 with your laker id
		  Person3 p3 = new Person3("Albert");
		  toPrint += p3.toString("900718195");
